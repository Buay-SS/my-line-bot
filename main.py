# === FINAL, COMPLETE, AND VERIFIED main.py (Health Check Included) ===
import os, json, re
...
# --- ระบบ Cache และฟังก์ชัน Helpers ---
_spreadsheet = None
_aliases_cache = None
_config_cache = None
...
# --- Web Server Routes (Health Check Included) ---
...
# --- Event Handlers (Plain Text Summary Version) ---
